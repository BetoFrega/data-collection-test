...
um listener para o evento de click é inserido em cada botão para exibir o primeiro trecho do nome do botão
...
(function(selector){
	...
	Array.prototype.forEach.call(buttons, function(el, i){
		el.addEventListener('click',function(){
			console.log(el.innerHTML.substr(0,el.innerHTML.indexOf('-')));
